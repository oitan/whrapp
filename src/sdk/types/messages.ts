...
import { GeneralRequestBody, RequesterResponseInterface } from "./requester.ts";
...
type TextParametersObject =
    & ParametersObject<ParametersTypesEnum.Text>
    & SimpleTextObject;
...
type ImageParametersObject =
    & ParametersObject<ParametersTypesEnum.Image>
    & ImageMediaObject;

type VideoParametersObject =
    & ParametersObject<ParametersTypesEnum.Video>
    & VideoMediaObject;
