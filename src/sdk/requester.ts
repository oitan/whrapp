...
import HttpsClient from "./httpsClient.ts";
import { HttpMethodsEnum } from "./types/enums.ts";
import { GeneralHeaderInterface, RequesterClass } from "./types/requester.ts";
...
export default class Requester implements RequesterClass {
    ...
    async sendCAPIRequest(
        ...
        LOGGER.log(
            `${method} : ${this.protocol.toLowerCase()}//${this.host}:${this.port}/${
